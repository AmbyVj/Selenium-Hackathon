...
public class TestCase12 extends Utility{
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("fname")).sendKeys("New Accounts");
        driver.findElement(By.id("devname")).clear();
        driver.findElement(By.id("devname")).sendKeys("New Accounts");;
        Thread.sleep(1000);
//        driver.findElement(By.id("devname")).clear();
//        driver.findElement(By.id("devname")).sendKeys("A123");
